...
const sqlitestmt = createClient({
  ...
  authToken: 'eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJleHAiOjE3NTczNjAxMzUsImlhdCI6MTc1NzI3MzczNSwiaWQiOiJmNmJiODcxYi00MWNlLTRkNzQtOGE0YS04NjY1OGRiYWFiMWMiLCJyaWQiOiI2YjA4ZTk1Yi1kYTU1LTQ0NTItYmNhYi05YmEzODA2MzhkNmMifQ.M10MmNEgWj5n_jSH61tVOthylQmPXtRG-EG7y-ws6zxJ0aKrIy8NM-ra-EJJSqBkeSoXO80HxsqR7qy0dBufAw'
})
...
async function main() {
  ...
  await sqlitestmt.execute({
  sql: 'INSERT INTO tblusuarios (id, nombre, correo, contrasena) VALUES (?, ?, ?, ?)',
